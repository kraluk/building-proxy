...
// This is a contract class that represents the HTTP response of the Building entity. However, at some point, it can be omitted
// and the domain class can be used directly in the controller layer to avoid boilerplate code and the additional mappings.
// Sure, it won't be a super-clean solution, but if the performance is a concern, it can be, let's say, a good trade-off.
